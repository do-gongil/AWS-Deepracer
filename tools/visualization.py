...
# x, y 좌표 분리
x_coords = [point[0] for point in racing_track]
y_coords = [point[1] for point in racing_track]

# 그래프 그리기
plt.figure(figsize=(8, 8))
plt.plot(x_coords, y_coords, 'b-', linewidth=2, label="Racing Line")
plt.scatter(x_coords, y_coords, c='red', s=6, label="Waypoints")
plt.xlabel('X')
plt.ylabel('Y')
plt.title('AWS DeepRacer Spain Track Racing Line')
plt.legend()
plt.grid(True)
plt.axis('equal')
plt.show()
